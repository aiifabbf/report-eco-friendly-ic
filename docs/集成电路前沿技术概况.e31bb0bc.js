...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"auto-numbering.js":[function(require,module,exports) {
document.addEventListener("readystatechange", function () {
  var figures = Array.from(document.querySelectorAll("figure > img")).map(function (s) {
    return s.parentElement;
  }); // find all figures

  var tables = Array.from(document.querySelectorAll("figure > table")).map(function (s) {
    return s.parentElement;
  }); // find all tables
  ...
  references.map(function (reference) {
    ...
    if (target) {
      // target might not exist at all
      [figures, tables, bibitems].map(function (typeSet) {
        if (typeSet.indexOf(target) !== -1) {
          if (typeSet === bibitems) {
            // it is referring to a bibitem, which has [data-id] on the li
            caption = target;
            reference.setAttribute("data-target-bibitem-id", caption.getAttribute("data-id"));
          } else {
            // it is referring to a figure or table, which has [data-id] not on the figure, but on the figcaption
...
},{}],"bibitems.json":[function(require,module,exports) {
module.exports = [{
  "label": "guardian2017",
  "authors": null,
  ...
  "label": "kim2013",
  "authors": "Bumman Kim et al",
  "title": "Push the Envelope: Design Concepts for Envelope-Tracking Power Amplifiers",
  "journal": "IEEE Microwave Magazine",
  "other": "2013"
}, {
  "label": "tan2017",
  "authors": "Min Tan et al",
  ...
  "journal": "IEEE RCIC Virtual Journal",
  "other": "1936"
}, {
  "label": "zee1999",
  "authors": "R. A. R. van der Zee",
...
module.exports = {
  ...
  "doherty-pa": require("./doherty-pa.png"),
  "hybrid-supply-modulator": require("./hybrid-supply-modulator.png"),
...
var _bibitems = _interopRequireDefault(require("./bibitems.json"));

var _ = _interopRequireDefault(require("./*.png"));
...
var app = new _vue.default({
  ...
  data: {
    ...
    bibitems: _bibitems.default
  }
});
window.app = app;
},{"./auto-numbering":"auto-numbering.js","vue/dist/vue":"node_modules/vue/dist/vue.js","./bibitems.json":"bibitems.json","./*.png":"*.png"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
